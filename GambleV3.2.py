...
#------------------------------
print("-------")
print("Lottery 1, Costs:",lotCost1,"Rewards:",prize1,"Chance: 1 in",lotChance1)
print("Lottery 2, Costs:",lotCost2,"Rewards:",prize2,"Chance: 1 in",lotChance2)
print("Lottery 3, Costs:",lotCost3,"Rewards:",prize3,"Chance: 1 in",lotChance3)
print("Lottery 4, Costs:",lotCost4,"Rewards:",prize4,"Chance: 1 in",lotChance4)
print("Lottery 5, Costs:",lotCost5,"Rewards:",prize5,"Chance: 1 in",lotChance5)
print("-------")
#variable mini storage 4 ------
#1 stats
...
while (Alive == 1):
    if (currency > 1 and debt == 0 or cooldown3 > 0):
        while (TY != "old" and TY != "new" and TY != "lottery" and TY != "raffle"):
            TY = input("Im sorry, I dont understand, would you like to use a old machine, our new next gen machines, our lottery tickets, or our raffle?(old/new/lottery)")
        if (TY == "old"):
            #OLD MACHIE
            if (GMN == "0"):
                ...
                if (NMN == "2" and currency > 1 or (cooldown3 > 0 and NMN == "2")):
                    ...
                    if ((wager2 == wagerMin1 or wager2 > wagerMin1) and (wager2 == maxCurrency or wager2 < maxCurrency)):
                        ...
                        if (x == newChance2):
                            ...
                            print("you rolled:",x,"of",newChance2)
                            time.sleep(0.5)
                            print("YOU WON, just kidding lol")
                            print("I'll totalllyyyy give you 10000 dollars")
                            time.sleep(0.5)
        ...
        if (TY == "lottery"):
            ...
            if (LMN == "1" or LMN == "2" or LMN == "3" or LMN == "4" or LMN == "5"):
                if (LMN == "1" and currency > 1 or (cooldown3 > 0 and LMN == "1")):
                    ...
                    currency = (currency - lotCost1)
                    if (x == lotChance1):
                        print("you rolled:",x,"of",lotChance1)
                        time.sleep(1)
                        print("you win, I guess...")
                        print("I'll give you your money... when i feel like it though... just hold on")
                        time.sleep(5)
                        currency = (currency + prize1)
                        maxCurrency = (maxCurrency + prize1)
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    elif (x > (lotChance1 / 1.25)):
                        print("you rolled:",x,"of",lotChance1)
                        time.sleep(1)
                        print("you win... kinda")
                        time.sleep(1)
                        currency = (currency + (prize1 / 50))
                        maxCurrency = (maxCurrency + (prize1 / 50))
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    elif (x > (lotChance1 / 10)):
                        print("you rolled:",x,"of",lotChance1)
                        time.sleep(1)
                        print("you win... barely")
                        time.sleep(1)
                        currency = (currency + (prize1 / 1000))
                        maxCurrency = (maxCurrency + (prize1 / 1000))
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    else:
                        print("you rolled:",x,"of",lotChance1)
                        time.sleep(1)
                        print("You lose... that kinda sucks")
                        time.sleep(1)
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                if (LMN == "2" and currency > 1 or (cooldown3 > 0 and LMN == "2")):
                    x = random.randint(1,lotChance2)
                    currency = (currency - lotCost2)
                    if (x == lotChance2):
                        print("you rolled:",x,"of",lotChance2)
                        time.sleep(1)
                        print("you win, I guess...")
                        print("I'll give you your money... when i feel like it though... just hold on")
                        time.sleep(5)
                        currency = (currency + prize2)
                        maxCurrency = (maxCurrency + prize2)
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    elif (x > (lotChance2 / 1.01)):
                        print("you rolled:",x,"of",lotChance2)
                        time.sleep(1)
                        print("you win... kinda")
                        time.sleep(1)
                        currency = (currency + (prize2 / 500))
                        maxCurrency = (maxCurrency + (prize2 / 500))
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    elif (x > (lotChance2 / 1.5)):
                        print("you rolled:",x,"of",lotChance2)
                        time.sleep(1)
                        print("you win... barely")
                        time.sleep(1)
                        currency = (currency + (prize2 / 10000))
                        maxCurrency = (maxCurrency + (prize2 / 10000))
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    else:
                        print("you rolled:",x,"of",lotChance2)
                        ...
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                if (LMN == "3" and currency > 1 or (cooldown3 > 0 and LMN == "3")):
                    x = random.randint(1,lotChance3)
                    currency = (currency - lotCost3)
                    if (x == lotChance3):
                        print("you rolled:",x,"of",lotChance3)
                        time.sleep(1)
                        print("you win, I guess...")
                        print("I'll give you your money... when i feel like it though... just hold on")
                        time.sleep(5)
                        currency = (currency + prize3)
                        maxCurrency = (maxCurrency + prize3)
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    elif (x > (lotChance3 / 1.01)):
                        print("you rolled:",x,"of",lotChance3)
                        time.sleep(1)
                        print("you win... kinda")
                        time.sleep(1)
                        currency = (currency + (prize3 / 50000))
                        maxCurrency = (maxCurrency + (prize3 / 50000))
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    elif (x > (lotChance3 / 1.5)):
                        print("you rolled:",x,"of",lotChance3)
                        time.sleep(1)
                        print("you win... barely")
                        time.sleep(1)
                        currency = (currency + (prize3 / 10000000))
                        maxCurrency = (maxCurrency + (prize3 / 10000000))
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    else:
                        print("you rolled:",x,"of",lotChance3)
                        ...
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                if (LMN == "4" and currency > 1 or (cooldown3 > 0 and LMN == "4")):
                    x = random.randint(1,lotChance4)
                    currency = (currency - lotCost4)
                    if (x == lotChance4):
                        print("you rolled:",x,"of",lotChance4)
                        time.sleep(1)
                        print("you win, I guess...")
                        print("I'll give you your money... when i feel like it though... just hold on")
                        time.sleep(5)
                        currency = (currency + prize4)
                        maxCurrency = (maxCurrency + prize4)
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    elif (x > (lotChance4 / 1.01)):
                        print("you rolled:",x,"of",lotChance4)
                        time.sleep(1)
                        print("you win... kinda")
                        time.sleep(1)
                        currency = (currency + (prize4 / 50000))
                        maxCurrency = (maxCurrency + (prize4 / 50000))
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    elif (x > (lotChance4 / 1.2)):
                        print("you rolled:",x,"of",lotChance4)
                        time.sleep(1)
                        print("you win... barely")
                        time.sleep(1)
                        currency = (currency + (prize4 / 1000000))
                        maxCurrency = (maxCurrency + (prize4 / 1000000))
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    else:
                        print("you rolled:",x,"of",lotChance4)
                        ...
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                if (LMN == "5" and currency > 1 or (cooldown3 > 0 and LMN == "5")):
                    x = random.randint(1,lotChance5)
                    currency = (currency - lotCost5)
                    if (x == lotChance5):
                        print("you rolled:",x,"of",lotChance5)
                        time.sleep(1)
                        print("you win, I guess...")
                        print("I'll give you your money... when i feel like it though... just hold on")
                        time.sleep(5)
                        currency = (currency + prize5)
                        maxCurrency = (maxCurrency + prize5)
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    elif (x > (lotChance5 / 1.01)):
                        print("you rolled:",x,"of",lotChance5)
                        time.sleep(1)
                        print("you win... kinda")
                        time.sleep(1)
                        currency = (currency + (prize5 / 300000000))
                        maxCurrency = (maxCurrency + (prize5 / 300000000))
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    elif (x > (lotChance5 / 1.5)):
                        print("you rolled:",x,"of",lotChance5)
                        time.sleep(1)
                        print("you win... barely")
                        time.sleep(1)
                        currency = (currency + (prize5 / 5000000000))
                        maxCurrency = (maxCurrency + (prize5 / 5000000000))
                        print("you have",currency,"dollars")
                        print("------------------------------------")
                    else:
                        print("you rolled:",x,"of",lotChance5)
                ...
                if (again == "y" and currency > 1 or (cooldown3 > 0 and again == "y")):
                    ...
                    LMN = input("OK, what machine would you like to use?(1/2/3/4/5)")
                if (cooldown4 != 0 and currency > 1 or (cooldown3 > 0 and cooldown4 != 0)):
                    cooldown4 = cooldown4 - 1
                elif (cooldown4 == 0 and currency > 1 or (cooldown3 > 0 and cooldown4 == 0)):
                    again2 = input("would you like to keep using new gambling machines?(y/n) ")
                    cooldown4 = 15
                while (again2 != "y" and again2 != "n"):
                    again2 = input("Im sorry, I dont undertsand, would you like to keep using lottery machines?(y/n) ")
                if (again2 == "n"):
                    TY = input("would you like to use a old machine, our new next gen machines, our lottery tickets, or our raffle?(old/new/lottery/raffle) ")
            else:
        ...
        if (work == "y"):
            ...
            cooldown3 = 5
if (ending == 1):
    print("You got murdered by the mafia for being in too much debt (Bad Ending 1")
print("    Made by: Koen Kulow (Online Alias: Rainbow)")
